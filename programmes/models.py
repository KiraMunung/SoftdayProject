...
class Niveaux(models.Model):
    ...
    image = models.ImageField(upload_to = 'niveau', blank=True)
...
class Lecon(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("programmes:leconlist", kwargs={"slug": self.matiere.slug, "niveau": self.niveau.slug })



class Commentaire(models.Model):
    nom_lesson = models.ForeignKey(Lecon, null=True, on_delete=models.CASCADE, related_name='comments')
...
class Reponse(models.Model):
    ...
    def __str__(self):
        return "reponse à " + str(self.nom_comm.nom_comm)
